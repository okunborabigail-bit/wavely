  ...
  return (
    <section className="flex flex-col items-center py-20">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mt-6 flex flex-col items-center">
        <img src="/src/assets/pininterest 1.jpg" alt="Album cover" className="w-48 h-48 rounded"  />
        <div className="mt-4">
          <p className="text-lg text-[#574964]">Feel good</p>
          <p className="text-gray-600">Dega</p>
        </div>
